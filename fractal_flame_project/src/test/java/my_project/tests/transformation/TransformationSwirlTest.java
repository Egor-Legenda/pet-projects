...
public class TransformationSwirlTest {
    private Transformation transformationDisc;

    @BeforeEach
    public void setUp() {
        transformationDisc = new TransformationSwirl();
    }
    ...
    public void testAlongYAxis() {
        ...
        assertEquals(-0.5403023058681398, transformedX1, 0.0001);
        assertNotEquals(1.3072872417272239, transformedY1, 0.0001);
        ...
        assertEquals(1.30728724172722, transformedX2, 0.0001);
